  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-gray-100 p-8">
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleLogin} className="space-y-4 bg-white border border-gray-200 rounded-lg p-8 shadow-sm">
          <div>
            <label
              htmlFor="email"
            ...
            <input
              ...
              type="email"
              required
              className="w-full px-3 py-2 bg-gray-50 border border-gray-300 rounded-md text-gray-900 focus:ring-purple-500 focus:border-purple-500"
